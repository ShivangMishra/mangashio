...
export const coverPic = require('./assets/cover-pic.png');
export const profilePic = require('./assets/profile-pic.png');
export const topImage = require('./assets/oshinoko.png');
...
export const nextArrow = require('./assets/next-arrow.png');
